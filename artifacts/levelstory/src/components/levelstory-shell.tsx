    ...
    <div className="noise min-h-[100dvh] bg-background text-foreground">
      ...
      <div className="lg:pl-[238px]">
        <header className="sticky top-0 z-30 flex h-[62px] items-center justify-between border-b border-border/80 bg-background/92 px-4 backdrop-blur-md sm:px-7 lg:px-9">
          ...
          <div className="hidden items-center gap-3 lg:flex"><span className="h-1.5 w-1.5 rounded-full bg-[hsl(var(--positive))]" /><span className="eyebrow text-muted-foreground">Focus session</span><span className="text-xs text-muted-foreground/70">/ primary trade window</span><span className="h-4 w-px bg-border" /><span className="mono text-[10px] text-muted-foreground/65">CAUSAL DATA ONLY</span></div>
