...
const STRATEGY_ENGINE_VERSION = "phase12-strategy-engine-v13-entry-candle-gap-exit";
const CANDIDATE_PROJECTION_VERSION = "candidate-projection-v18-entry-candle-gap-exit";
