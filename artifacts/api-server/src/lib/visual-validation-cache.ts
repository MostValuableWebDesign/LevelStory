...
export const VISUAL_VALIDATION_CACHE_KEY_VERSION = "visual-review-cache-v24-causal-source-identity";
export const VISUAL_VALIDATION_STRATEGY_ENGINE_VERSION = "phase12-strategy-engine-v19-causal-source-identity";
export const VISUAL_VALIDATION_CANDIDATE_PROJECTION_VERSION = "candidate-projection-v24-causal-source-identity";
export const VISUAL_VALIDATION_EXECUTION_MANAGEMENT_VERSION = "execution-management-v22-causal-source-identity";
export const VISUAL_VALIDATION_SNAPSHOT_PROJECTION_VERSION = "snapshot-projection-v19-causal-source-identity";
export const VISUAL_VALIDATION_CHART_PROJECTION_VERSION = "chart-projection-v14-causal-source-identity";
