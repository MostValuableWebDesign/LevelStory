...
export const VISUAL_VALIDATION_CACHE_KEY_VERSION = "visual-review-cache-v4";
...
export const VISUAL_VALIDATION_EXECUTION_MANAGEMENT_VERSION = "execution-management-v5-adaptive-atr-fixed-size-audit";
