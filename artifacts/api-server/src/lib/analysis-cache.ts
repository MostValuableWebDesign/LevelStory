...
export const STRATEGY_RESULT_CACHE_KEY_VERSION = "strategy-result-cache-v10-causal-direction-integrity";
export const BATCH_AGGREGATION_CACHE_KEY_VERSION = "batch-aggregation-v6-causal-direction-integrity";
