...
export const STRATEGY_RESULT_CACHE_KEY_VERSION = "strategy-result-cache-v12-independent-patience-switch";
export const BATCH_AGGREGATION_CACHE_KEY_VERSION = "batch-aggregation-v8-independent-patience-switch";
