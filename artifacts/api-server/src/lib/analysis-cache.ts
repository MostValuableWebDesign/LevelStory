...
export const STRATEGY_RESULT_CACHE_KEY_VERSION = "strategy-result-cache-v11-causal-source-identity";
export const BATCH_AGGREGATION_CACHE_KEY_VERSION = "batch-aggregation-v7-causal-source-identity";
