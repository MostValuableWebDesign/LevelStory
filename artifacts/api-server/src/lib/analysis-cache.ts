...
export const STRATEGY_RESULT_CACHE_KEY_VERSION = "strategy-result-cache-v9-bound-chronology-evidence";
export const BATCH_AGGREGATION_CACHE_KEY_VERSION = "batch-aggregation-v5-bound-chronology-evidence";
