...
test("Phase 8 simulates a qualified equivalent reversal only in shadow mode", () => {
  const timeline = buildPhase8Timeline({
    ...
    patience: { state: "ENTRY_TRIGGERED", eligible: true, eligibilityReason: "pullback", eligibilityTime: 1, trend: "bullish", previousCandle: null, patienceCandle: { openTime: 1, closeTime: 2, open: 1, high: 2, low: 1, close: 1.5, isComplete: true }, triggerCandle: { openTime: 2, closeTime: 3, open: 1.5, high: 4, low: 1.5, close: 3.5, isComplete: true }, entryBufferTicks: 8, entryBufferPrice: 4, stopBufferTicks: 1, strategyStopPrice: 0.75, triggerPrice: 4, stateTime: 3, detail: "Triggered." },
