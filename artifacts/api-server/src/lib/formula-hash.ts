...
export const FIXED_FORMULA_VERSION = "phase9-fixed-formula-v23.5-countertrend-reversal-no-peak-retracement-threshold-orb-trend-epochs-account-single-active-trade-no-target-breakeven-patience-continuation-orb-attribution-authorized-direct-entry-stop-contracts-direct-identity-equivalent-pair-validation-causal-same-candle-consolidation";
...
export function formulaConfiguration(
  ...
  return {
    ...
    fixedConstraints: {
      ...
      directConsolidationSameCandleRule: "ordered qualification timestamp must precede ordered threshold crossing; otherwise use the next completed candle",
      noFutureData: true,
