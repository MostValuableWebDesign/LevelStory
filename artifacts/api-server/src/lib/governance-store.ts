...
export async function supersedeTeachingEvidence(args: {
  ...
  const [created] = await db.insert(teachingExamplesTable).values({
    ...
    levelCandleTimestamp: existing.levelCandleTimestamp,
    patienceCandleTimestamp: existing.patienceCandleTimestamp,
    direction: existing.direction,
    entryBufferTicks: existing.entryBufferTicks,
    levelToleranceTicks: existing.levelToleranceTicks,
    qualifyingLevelId: existing.qualifyingLevelId,
    qualifyingLevelValue: existing.qualifyingLevelValue,
    qualifyingLevelRangeLow: existing.qualifyingLevelRangeLow,
    qualifyingLevelRangeHigh: existing.qualifyingLevelRangeHigh,
    qualifyingLevelDistanceTicks: existing.qualifyingLevelDistanceTicks,
    consolidationMetadata: existing.consolidationMetadata,
    indicatorSourceTimestamp: existing.indicatorSourceTimestamp,
