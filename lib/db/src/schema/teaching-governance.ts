...
export const teachingExamplesTable = pgTable("levelstory_teaching_examples", {
  ...
  levelCandleTimestamp: text("level_candle_timestamp"),
  ...
  qualifyingLevelId: text("qualifying_level_id"),
  qualifyingLevelValue: text("qualifying_level_value"),
  qualifyingLevelRangeLow: text("qualifying_level_range_low"),
  qualifyingLevelRangeHigh: text("qualifying_level_range_high"),
  qualifyingLevelDistanceTicks: integer("qualifying_level_distance_ticks"),
  consolidationMetadata: jsonb("consolidation_metadata"),
  indicatorSourceTimestamp: text("indicator_source_timestamp"),
  ...
  qualifyingLevels: jsonb("qualifying_levels").notNull().default([]),
