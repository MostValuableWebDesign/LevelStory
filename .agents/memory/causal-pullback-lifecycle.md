...
**How to apply:** Keep old duration values in replay evidence for comparison, but do not use them to truncate pullback candles or change an otherwise valid pullback to expired.