...
**How to apply:** Keep target-plan identity alongside candidate-owned management and propagate it into modeled trade audit and Visual Review; never let legacy target fields replace an already-frozen candidate plan.